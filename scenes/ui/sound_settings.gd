...
@onready var _music_on_texture: CompressedTexture2D = preload("res://assets/graphic/ui/btn/misic.png")
@onready var _music_off_texture: CompressedTexture2D = preload("res://assets/graphic/ui/btn/music_off.png")
@onready var _sfx_on_texture: CompressedTexture2D = preload("res://assets/graphic/ui/btn/sound.png")
@onready var _sfx_off_texture: CompressedTexture2D = preload("res://assets/graphic/ui/btn/sound_off.png")
