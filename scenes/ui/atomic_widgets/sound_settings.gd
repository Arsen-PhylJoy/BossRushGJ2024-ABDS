...
@onready var _music_off_texture: CompressedTexture2D = preload("res://assets/graphic/ui/music_off.png")
@onready var _sfx_on_texture: CompressedTexture2D = preload("res://assets/graphic/ui/sound.png")
@onready var _sfx_off_texture: CompressedTexture2D = preload("res://assets/graphic/ui/sound_off.png")
